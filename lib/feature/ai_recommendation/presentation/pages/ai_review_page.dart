...
class AiReviewPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AiRecommendationBloc, AiRecommendationState>(
      builder: (context, state) {
        ...
        final review = feed.reviewInsights;
                ...
                children: <Widget>[
                  ...
                  Wrap(
                    ...
                    children: review.themes.map((theme) {
                      final isPrimary = theme == 'Great Service';
                      return Container(
...
class _BreakdownRow extends StatelessWidget {
  final AiRecommendationReviewBreakdown item;
...
class _ReviewCard extends StatelessWidget {
  final AiRecommendationReviewItem item;
  ...
  Widget build(BuildContext context) {
    if (item.isHidden) {
      final canShowReason = isTransparencyEnabled || isRevealed;
      return Container(
        width: double.infinity,
