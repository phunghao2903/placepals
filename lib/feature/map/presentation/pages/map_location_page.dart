...
import '../widgets/map_location_tile.dart';
...
class _MapLocationPageState extends State<MapLocationPage> {
  ...
  void initState() {
    ...
    _searchController = TextEditingController(
      text: context.read<MapBloc>().state.locationQuery,
    );
  }
      ...
      body: SafeArea(
        child: BlocBuilder<MapBloc, MapState>(
          builder: (context, state) {
            ...
            final places = _filterPlaces(feed.nearbyPlaces, state.locationQuery);
                ...
                Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      _MapLocationSearchField(
                        controller: _searchController,
                        hintText: feed.locationSearchHint,
                        onChanged: (value) {
                          context.read<MapBloc>().add(
                            MapLocationQueryChanged(query: value),
                          );
                        },
                      ),
                    ],
                            ...
                            children: <Widget>[
                              ...
                              IconButton(
                                onPressed: () {
                                  ...
                                  context.read<MapBloc>().add(
                                    const MapLocationQueryChanged(query: ''),
                                  );
                                },
                                icon: const Icon(
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return MapLocationTile(
                                ...
                                onTap: () {
                                  context.read<MapBloc>().add(
                                    MapLocationSelected(place: place),
                                  );
  ...
  List<MapSearchPlace> _filterPlaces(
    List<MapSearchPlace> places,
    String query,
  ) {
...
class _MapLocationSearchField extends StatelessWidget {
  final TextEditingController controller;
  final String hintText;
  final ValueChanged<String> onChanged;

  const _MapLocationSearchField({
